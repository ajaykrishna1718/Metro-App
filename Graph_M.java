...
import java.io.*;
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			g.addVertex("Secundrabad");
			g.addVertex("Miyapur");
			g.addVertex("Kukatpelli");
			g.addVertex("Uppal");
			g.addVertex("Patinee");
			g.addVertex("Nagole");
			...
			g.addEdge("Secundrabad", "Miyaput", 8);
			g.addEdge("Botanical Garden~B", "Kukatpelli", 10);
			g.addEdge("Kukatpelli", "Patinee", 8);
			g.addEdge("Kukatpelli", "Uppal", 6);
			g.addEdge("Uppal", "Nagole", 9);
			g.addEdge("Nagole", "Paradise", 7);
			g.addEdge("Paradise", "Balagar", 6);
			g.addEdge("KPHB", "HITECH CITY", 15);
			g.addEdge("SHITECH CITY", "ECL", 6);
			g.addEdge("ECL", "Rajiv Chowk~BY", 7);
			g.addEdge("Rajiv Chowk~BY", "Ameerpet", 1);
			g.addEdge("Ameerpet", "Chandni Chowk~Y", 2);
			g.addEdge("Chandni Chowk~Y", "Vishwavidyalaya~Y", 5);
			g.addEdge("Ameerpet", "Shivaji Stadium~O", 2);
			g.addEdge("Shivaji Stadium~O", "DDS Campus~O", 7);
			g.addEdge("DDS Campus~O", "IGI Airport~O", 8);
			g.addEdge("Nagole", "Rajouri Garden~BP", 2);
			g.addEdge("Madhapur", "Rajouri Garden~BP", 2);
			g.addEdge("Madhapur", "JNTU", 3);
		}
